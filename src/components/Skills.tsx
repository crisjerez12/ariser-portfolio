...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-16 sm:py-20 bg-gray-800 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-7xl mx-auto">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-12 sm:mb-16 max-w-2xl mx-auto text-sm sm:text-base px-4">
            A comprehensive toolkit of modern technologies and frameworks that I use to build robust, scalable applications.
          </p>
              ...
              >
                ...
                <div className="space-y-3">
                  {category.skills.map((skill, skillIndex) => (
                    <div
                      key={skillIndex}
                      className={`border rounded-lg px-3 sm:px-4 py-2 sm:py-3 text-center font-medium transition-all duration-300 hover:scale-105 text-sm sm:text-base font-mono ${getColorClasses(category.color)}`}
                    >
                      {skill}
                    </div>
                  ))}
          ...
          <div className="mt-12 sm:mt-16 text-center">
            <div className="bg-gray-900 rounded-lg p-8 max-w-4xl mx-auto">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 text-white font-mono">Continuous Learning Journey</h3>
              <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
                As a passionate developer, I'm always expanding my skill set and staying updated with the latest technologies. 
                Currently exploring advanced React patterns, microservices architecture, and cloud deployment strategies.
              </p>
            </div>
          </div>
        </div>
